        ...
        <table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
            ...
            <c:forEach items="${pagination.list }" var="entry">
                ...
                <tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
                    ...
                    <td align="center">
                        <a class="pn-opt" href="javascript:void(0)" onclick="window.location.href='/brand/toEdit.do?id=${entry.id}'">修改</a> | <a class="pn-opt"  onclick="if(!confirm('您确定删除吗？')) {return false;} window.location.href='/brand/delete.do?id=${entry.id }&name=${entry.name}&isDisplay=${entry.isDisplay}'" href="javascript:void(0)">删除</a>
                    </td>
                </tr>
            </c:forEach>
